        ...
        <div className="card-body">
          <div className="space-y-3">
            <h2 className="card-title">
              <span className="text-blue-300 rounded-xl bg-purple-900 px-3">
                Assignment Link:-{" "}
              </span>
              <a
                href="#"
                className="hover:text-blue-600 border-b-blue-500 border-2"
              >
                {markingAssignment.assignmentLink}
              </a>
            </h2>
            <p>
              <span className="text-blue-400 rounded-xl bg-purple-900 px-3 ">
                {" "}
                Notes:
              </span>{" "}
              {markingAssignment.notes}{" "}
            </p>
          </div>
            ...
            <div className="flex flex-col items-center space-y-3">
              <div className="lg:w-6/12">
                ...
                <input
                  ...
                  name="marks"
                  placeholder="Give your marks here.."
                  required
                />
              </div>
              <div>
              ...
              <div className="w-full pt-5">
                <input
                  type="submit"
                  className="btn w-full bg-purple-300 border-none"
                  placeholder="Give your marks here.."
                />
              </div>
            </div>
