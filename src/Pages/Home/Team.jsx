        ...
        <div className="">
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 pb-12 mx-auto">
                    ...
                    Proactively reconceptualize 2.0 infomediaries with economically sound initiatives. Collaboratively embrace dynamic catalysts for change after e-business customer service. Synergistically matrix scalable.
                    </p>
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                        <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-purple-900/50 dark:border-gray-700 dark:hover:border-transparent">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/1TWjy8W/team1.jpg" alt=""/>

                                <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-black">Ellias Abdullah</h1>

                                <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-black">Founder of Study Room</p>
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-purple-900/50 dark:border-gray-700 dark:hover:border-transparent">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/Kx78239/team2.jpg" alt=""/>

                                <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-black">Samia Khandakar</h1>

                                <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-black">Co-Director</p>
                        ...
                        <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-purple-900/50 dark:border-gray-700 dark:hover:border-transparent">
                            <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/7rSY3pn/team4.jpg" alt=""/>

                                <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:black">Abu Sayem </h1>

                                <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-black">Instructor</p>
