    ...
    <div className=" flex justify-center p-4">
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800 bg-base-200">
        ...
        >
          ...
          <button
            type="submit"
            className="btn bg-purple-400 hover:bg-purple-300 border-none w-full px-8 py-3 text-xl font-bold rounded-md dark:bg-violet-600 dark:text-gray-50"
          >
            Register
          </button>
        </form>
        <p className="text-sm text-center dark:text-gray-600 mt-3">
          ...
          <Link to="/login">
            <span className="text-blue-600 font-bold">Login</span> here.
          </Link>
        </p>
      </div>
    </div>
