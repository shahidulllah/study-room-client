...
const Footer = () => {
  return (
    <div
      ...
      className="p-5 overflow-x-hidden lg:p-16 bg-black text-white"
    >
        ...
        <div className=" grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-10">
          <aside className="lg:row-span-2 col-span-2 md:col-span-4 lg:col-span-1 mb-6 flex flex-col justify-center space-y-2 h-full">
            <div className="flex items-center mb-3">
              <Link to="/">
                <div className="flex flex-col justify-center items-center gap-1">
                  <h1 className="">
                    <span className="text-4xl font-bold">Study</span>
                  </h1>
                  <h1>
                    <span className="bg-red-500 text-white rounded-2xl font-bold px-4 py- text-2xl font-serif">
                      Room
                    </span>
                  </h1>
                </div>
            ...
            <p>
              CDA Industries Ltd.
              <br />
              Your trusted Art and Craft Center.
            </p>
          </aside>
