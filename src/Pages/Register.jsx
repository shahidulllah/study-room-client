...
const Register = () => {
    ...
    return (
        <div className=" flex justify-center p-4">
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800 bg-base-200">
                <h2 className="mb-3 text-3xl font-bold text-center">Create an account</h2>
                ...
                <form onSubmit={handleRegister} noValidate="" action="" className="space-y-8">
                    <div className="space-y-4 mb-7">
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="email" name="email" id="email" placeholder="example@gamil.com" className=" input w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" required/>
                        </div>
                        <div className="space-y-2">
                    ...
                    <button type="submit" className="btn bg-purple-400 hover:bg-purple-300 border-none w-full px-8 py-3 text-xl font-bold rounded-md dark:bg-violet-600 dark:text-gray-50">Register</button>
                </form>
