        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <img
              ...
              src={detailAssignment.thumbnailImageURL}
            />
          ...
          <div className="flex justify-between">
            <div className="flex items-center">
              ...
              <span className="font-bold text-blue-400">
                {detailAssignment.difficultyLevel}
              </span>
            </div>
            <div>
              <div className="flex items-center">
          ...
          <div className=" pt-12">
            <Link to={`/takeAssignment/${detailAssignment._id}`}>
              {" "}
              <button
                type="button"
                className="flex btn bg-purple-300 items-center justify-center w-full font-extrabold tracking-wide rounded-md  "
              >
