...
const Navbar = () => {
  ...
  const navlinks = (
    <>
      <NavLink
        className={"  border-b-2 hover:bg-slate-300 px-3 py-2 rounded-lg"}
        to="/"
      >
        Home
      </NavLink>
          ...
          <div className="container flex justify-between h-auto mx-auto">
            <Link to="/">
              <div className="flex flex-col justify-center items-center">
                <h1 className="">
                  <span className="text-2xl lg:text-3xl font-bold">Study</span>
                </h1>
                <h1>
                  <span className="bg-red-500 text-white rounded-2xl font-bold px-4  text-sm font-serif">
                    Room
                  </span>
                </h1>
              </div>
              ...
              <div>
                {!user && (
                  <>
                    <NavLink to="/register">
                      {" "}
                      <button className="self-center btn-ghost px-3 py-1 mr-4 font-semibold rounded">
                        Register
                      </button>
                    </NavLink>
                    <NavLink to="/login">
                      {" "}
                      <button className="self-center btn-ghost px-3 py-1  font-semibold rounded">
                        Login
                      </button>
                    </NavLink>
                  </>
              ...
              {user && (
                <>
                  <div className="dropdown dropdown-end">
                    ...
                    >
                      <NavLink to="/myAssignment">
                        {" "}
                        <li className="border-slate-300 border-b">
            ...
            <button className="p-4 lg:hidden flex flex-col justify-center">
              <div className="dropdown dropdown-end">
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content z-[1] menu p-2 shadow bg-base-300 rounded-box w-52 border-slate-300 border-b"
                >
                  {user && (
                  ...
                  {user && (
                    <NavLink
                      className={
                        "  border-b-2 hover:bg-slate-300 px-3 py-2 rounded-lg"
                      }
                      to="/myAssignment"
                    >
                      My Assignments
